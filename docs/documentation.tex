...
% Define variables
\newcommand{\yearvar}{2026}
\newcommand{\appversion}{v1.0.4}
...
\textbf{Quick links:} 
\begin{itemize}
  \item \href{https://pr-dc.com/jslab/}{Website - pr-dc.com/jslab/}
  \item \href{https://pr-dc.com/jslab/web/}{Try it online - pr-dc.com/jslab/web/}
  \item \href{https://discourse.jsl.pr-dc.com/}{Discourse - discourse.jsl.pr-dc.com/}
  \item \href{https://pr-dc.com/jslab/doc/}{Documentation - pr-dc.com/jslab/doc/}
  \item \href{https://github.com/PR-DC/JSLAB/}{Source code - github.com/PR-DC/JSLAB/}
  \item \href{https://github.com/PR-DC/JSLAB/releases}{Releases - github.com/PR-DC/JSLAB/releases}
  \item \href{https://github.com/PR-DC/JSLAB/tree/master/examples}{Examples - github.com/PR-DC/JSLAB/tree/master/examples}
\end{itemize}
...
Use JSLAB directly in your browser: \href{https://pr-dc.com/jslab/web/}{https://pr-dc.com/jslab/web/}
...
If you use \textbf{JSLAB} in research that leads to a publication, please cite the following conference paper:

\begin{quote}
Petrasinovic M., Raicevic N., Petrovic M., Grbovic A.: \textit{JSLAB: An Open-Source JavaScript Environment for Scientific Computing and Visualization}, 4th EAI International Conference on Automation and Control in Theory and Practice (ARTEP 2026), Sromowce Ni{\v z}ne, Poland, 13-15 May 2026.
\end{quote}
...
For latest examples, visit our \textbf{Discourse} at \url{https://discourse.jsl.pr-dc.com}.
...
\begin{itemize}
    ...
    \item \textbf{Discourse:} Write a New Topic at \url{https://discourse.jsl.pr-dc.com/}
...
\vspace{5mm}
\noindent \codeBlock{\texttt{beep()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Returns:} \texttt{<boolean>}: True when the beep request was accepted.

\noindent Plays the operating system beep sound.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{addpath(args)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{args} \texttt{<string>}: Path entries to add.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<string>>}: Updated search path entries.

\noindent Adds one or more paths to the search path list.Alias compatible with MATLAB/Octave \textasciigrave{}addpath\textasciigrave{}.

\vspace{5mm}
\noindent \codeBlock{\texttt{rmpath(args)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{args} \texttt{<string>}: Path entries to remove.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<string>>}: Updated search path entries.

\noindent Removes one or more paths from the search path list.Alias compatible with MATLAB/Octave \textasciigrave{}rmpath\textasciigrave{}.

\vspace{5mm}
\noindent \codeBlock{\texttt{path(args)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{args} \texttt{<string>}: Path entries to set.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<string>>}: Active search path entries.

\noindent Retrieves or sets the active search path list.Compatible with MATLAB/Octave \textasciigrave{}path\textasciigrave{}.

\vspace{5mm}
\noindent \codeBlock{\texttt{ls([target])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{target} \texttt{<string>}: Folder, file, or wildcard.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<string>>}: Entry names.

\noindent Lists contents of a folder or wildcard target.Compatible with MATLAB/Octave \textasciigrave{}ls\textasciigrave{}.

\vspace{5mm}
\noindent \codeBlock{\texttt{dir([target])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<Array.<Object>>}: Directory entries.

\noindent Lists directory entries with metadata.Compatible with MATLAB/Octave \textasciigrave{}dir\textasciigrave{}.

\vspace{5mm}
\noindent \codeBlock{\texttt{isfile(path\_in)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{path\_in} \texttt{<string>}: Path or symbol.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: 

\noindent Returns true when the path resolves to a file.Compatible with MATLAB \textasciigrave{}isfile\textasciigrave{}.

\vspace{5mm}
\noindent \codeBlock{\texttt{isfolder(path\_in)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{path\_in} \texttt{<string>}: Path or folder symbol.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: 

\noindent Returns true when the path resolves to a folder.Compatible with MATLAB \textasciigrave{}isfolder\textasciigrave{}.

\vspace{5mm}
\noindent \codeBlock{\texttt{exist(name, [kind])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{name} \texttt{<string>}: Symbol or path.
  \item \texttt{kind} \texttt{<string>}: Optional query kind.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<number>}: Existence code.

\noindent Checks existence with MATLAB-compatible return codes.\textasciigrave{}1\textasciigrave{} variable, \textasciigrave{}2\textasciigrave{} file, \textasciigrave{}5\textasciigrave{} built-in, \textasciigrave{}7\textasciigrave{} directory, \textasciigrave{}0\textasciigrave{} missing.Supports typed queries: \textasciigrave{}'var'\textasciigrave{}, \textasciigrave{}'file'\textasciigrave{}, \textasciigrave{}'dir'|'folder'\textasciigrave{}, \textasciigrave{}'builtin'\textasciigrave{}.

\vspace{5mm}
\noindent \codeBlock{\texttt{which(name)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{name} \texttt{<string>}: File/module name.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<string>}: Resolved absolute path, or false if not found.

\noindent Resolves a file/module using the active search path.Compatible with MATLAB/Octave \textasciigrave{}which\textasciigrave{}.

\vspace{5mm}
\noindent \codeBlock{\texttt{who(names)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{names} \texttt{<string>}: Optional names to filter.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<string>>}: Variable names.

\noindent Lists workspace variable names.Compatible with MATLAB/Octave \textasciigrave{}who\textasciigrave{}.

\vspace{5mm}
\noindent \codeBlock{\texttt{whos(names)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<Array.<Array.<string>>>}: Workspace descriptor rows.

\noindent Lists workspace variable descriptors (name/type/class).Compatible with MATLAB/Octave \textasciigrave{}whos\textasciigrave{}.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{diary([mode\_or\_file])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{mode\_or\_file} \texttt{<string>}: Mode token or log file path.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: True when command was accepted.

\noindent Controls command window transcript logging.\textasciigrave{}diary()\textasciigrave{} toggles logging, \textasciigrave{}diary('on')\textasciigrave{} enables, \textasciigrave{}diary('off')\textasciigrave{} disables,and \textasciigrave{}diary('<file>')\textasciigrave{} enables logging to the specified file (append mode).
...
\vspace{5mm}
\noindent \codeBlock{\texttt{saveObject(value, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{value} \texttt{<*>}: Value to serialize.
  \item \texttt{options} \texttt{<Object>}: Serialization options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Object>}: Serialized payload.

\noindent Serializes a single value with class/reference metadata.

\vspace{5mm}
\noindent \codeBlock{\texttt{loadObject(payload, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{payload} \texttt{<Object>}: Serialized object payload.
  \item \texttt{options} \texttt{<Object>}: Deserialization options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Promise.<*>>}: Restored value.

\noindent Restores a single serialized value payload.

\vspace{5mm}
\noindent \codeBlock{\texttt{loadClass(class\_name, class\_path)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{class\_name} \texttt{<string>}: Class name.
  \item \texttt{class\_path} \texttt{<string>}: Class source path.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Promise.<boolean>>}: True if class was loaded.

\noindent Attempts to load a class definition into the workspace.
...
\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{file\_path} \texttt{<string>}: Path where variables will be saved.
  \item \texttt{args} \texttt{<string>}: Variables to save. If omitted or 'all', saves all workspace variables.
\end{itemize}

\noindent Saves specified variables to a file using workspace serializer.
...
\noindent Loads variables from a specified file into the specified scope or the default script context.Supports current JSLAB workspace format and legacy plain JSON object files.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{compileWasm(path, [show\_output])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{path} \texttt{<string>}: Path to a source file or directory containing sources.
  \item \texttt{show\_output} \texttt{<boolean>}: Whether to display the compiler output.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array>}: Tuple \textasciigrave{}[success, wasm\_path|undefined]\textasciigrave{}.

\noindent Compiles a WebAssembly module from C/C++ or Rust sources using the available toolchain.The method automatically selects \textasciigrave{}emcc\textasciigrave{} for native sources and \textasciigrave{}wasm-pack\textasciigrave{} when a Cargo.toml is present.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{lookfor(query)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{query} \texttt{<string>}: Search query.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<string>>}: Matching summary lines.

\noindent Searches documentation by keyword and prints matching symbols.MATLAB-compatible alias for documentation search.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{inspectVariable(variable\_name, [options], [options.max\_rows], [options.max\_cols], [options.max\_chars], [options.filter], [options.filter\_expr], [options.sort\_by], [options.sort\_dir])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{variable\_name} \texttt{<string>}: Variable name in workspace.
  \item \texttt{options} \texttt{<Object>}: Optional rendering options.
  \item \texttt{options.max\_rows} \texttt{<number>}: Maximum rows to render.
  \item \texttt{options.max\_cols} \texttt{<number>}: Maximum columns to render.
  \item \texttt{options.max\_chars} \texttt{<number>}: Maximum characters shown in a single cell.
  \item \texttt{options.filter} \texttt{<string>}: Case-insensitive substring row filter.
  \item \texttt{options.filter\_expr} \texttt{<string>}: JavaScript expression filter using row object.
  \item \texttt{options.sort\_by} \texttt{<string>}: Sort column key.
  \item \texttt{options.sort\_dir} \texttt{<string>}: Sort direction.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: True when rendered.

\noindent Displays a spreadsheet-like inspector for a workspace variable in the command window.

\vspace{5mm}
\noindent \codeBlock{\texttt{inspectSetVariable(variable\_name, path, expression)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{variable\_name} \texttt{<string>}: Workspace variable name.
  \item \texttt{path} \texttt{<Array>}: Property/index path.
  \item \texttt{expression} \texttt{<string>}: JavaScript expression representing new value.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: True if updated.

\noindent Sets variable value at path using a JavaScript expression from inspector.

\vspace{5mm}
\noindent \codeBlock{\texttt{inspectTableAction(variable\_name, action, [payload])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{variable\_name} \texttt{<string>}: Workspace variable name.
  \item \texttt{action} \texttt{<string>}: Action name.
  \item \texttt{payload} \texttt{<Object>}: Action payload.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: True when action is completed.

\noindent Executes table inspector actions that change table structure/content.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{buildGridFromFlat(xFlat, yFlat, zFlat, [tolIn], [tolIn.tolX], [tolIn.tolY])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{xFlat} \texttt{<Array>}: Flattened x coordinates (length N).
  \item \texttt{yFlat} \texttt{<Array>}: Flattened y coordinates (length N).
  \item \texttt{zFlat} \texttt{<Array>}: Flattened z values (length N).
  \item \texttt{tolIn} \texttt{<Object>}: Optional tolerance settings.
  \item \texttt{tolIn.tolX} \texttt{<number>}: Quantization tolerance for x axis detection.
  \item \texttt{tolIn.tolY} \texttt{<number>}: Quantization tolerance for y axis detection.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Object>}: Grid object: \{ xAxis, yAxis, Z, m, n, filled \}.

\noindent Builds a rectilinear grid (xAxis, yAxis, Z[y][x]) from flattened grid arrays.Ordering can be arbitrary. Values that are NaN/Inf are ignored.

\vspace{5mm}
\noindent \codeBlock{\texttt{gridSolveYforXZ(x, y, z, x0, z0, [opts], [opts.extrap], [opts.eps], [opts.tolIn], [opts.minFill], [opts.allowMissing], [opts.minFillIfMissing])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{x} \texttt{<Array>}: X axis (grid) OR flattened x coordinates.
  \item \texttt{y} \texttt{<Array>}: Y axis (grid) OR flattened y coordinates.
  \item \texttt{z} \texttt{<Array>}: Z grid (2D) OR flattened z values.
  \item \texttt{x0} \texttt{<number>}: Known x.
  \item \texttt{z0} \texttt{<number>}: Known z.
  \item \texttt{opts} \texttt{<Object>}: Optional settings.
  \item \texttt{opts.extrap} \texttt{<boolean>}: Allow x0 outside x-range by clamping to edge.
  \item \texttt{opts.eps} \texttt{<number>}: Tolerance for root detection.
  \item \texttt{opts.tolIn} \texttt{<Object>}: Optional tolerances for grid rebuild (passed to buildGridFromFlat).
  \item \texttt{opts.minFill} \texttt{<number>}: Minimum filled ratio to accept as grid.
  \item \texttt{opts.allowMissing} \texttt{<boolean>}: If true, allow lower fill ratio.
  \item \texttt{opts.minFillIfMissing} \texttt{<number>}: Minimum filled ratio when allowMissing is true.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array>}: Array of y solutions.

\noindent Finds y values where z(x0, y) == z0 on a rectilinear grid.If z is a flat array, the function tries to rebuild a grid automatically.Returns an array of solutions (can be empty or multiple).

\vspace{5mm}
\noindent \codeBlock{\texttt{gridSolveXforYZ(x, y, z, y0, z0, [opts], [opts.extrap], [opts.eps], [opts.tolIn], [opts.minFill], [opts.allowMissing], [opts.minFillIfMissing])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\begin{itemize}
  ...
  \item \texttt{y} \texttt{<Array>}: Y axis (grid) OR flattened y coordinates.
  \item \texttt{z} \texttt{<Array>}: Z grid (2D) OR flattened z values.
  \item \texttt{y0} \texttt{<number>}: Known Y.
  \item \texttt{z0} \texttt{<number>}: Known z.
  \item \texttt{opts} \texttt{<Object>}: Optional settings.
  \item \texttt{opts.extrap} \texttt{<boolean>}: Allow y0 outside y-range by clamping to edge.
  \item \texttt{opts.eps} \texttt{<number>}: Tolerance for root detection.
  \item \texttt{opts.tolIn} \texttt{<Object>}: Optional tolerances for grid rebuild (passed to buildGridFromFlat).
  \item \texttt{opts.minFill} \texttt{<number>}: Minimum filled ratio to accept as grid.
  \item \texttt{opts.allowMissing} \texttt{<boolean>}: If true, allow lower fill ratio.
...
\noindent Finds x values where z(x, y0) == z0 on a rectilinear grid.If z is a flat array, the function tries to rebuild a grid automatically.Returns an array of solutions (can be empty or multiple).
...
\noindent \textbf{Returns:} \texttt{<string>}: The polynomial string formatted for C syntax.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{clamp(v, a, b)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{v} \texttt{<number>}: The value to clamp.
  \item \texttt{a} \texttt{<number>}: The lower bound.
  \item \texttt{b} \texttt{<number>}: The upper bound.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<number>}: The clamped value.

\noindent Clamps a value to the inclusive range [a, b].Assumes a <= b.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{resetTimeout(id, fun, dt)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{id} \texttt{<number>}: timeout id.
  \item \texttt{fun} \texttt{<number>}: timeout function.
  \item \texttt{dt} \texttt{<number>}: timeout dt.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<number>}: timeout id.

\noindent Reset timeout
...
\vspace{5mm}
\noindent \codeBlock{\texttt{openDiscourse()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent Opens window with discourse

\vspace{5mm}
\noindent \codeBlock{\texttt{openWebpage([url])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{url} \texttt{<String>}: URL of webpage.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Promise.<Object>>}: A promise that resolves to the window context.

\noindent Opens window with webpage
...
\vspace{5mm}
\noindent \codeBlock{\texttt{transpose2D(A)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{A} \texttt{<Array.<Array>>}: Input matrix.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<Array>>}: Transposed matrix.

\noindent Transposes a 2D matrix.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{toRC(val, [deadzone])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{val} \texttt{<number>}: The input value to convert.
  \item \texttt{deadzone} \texttt{<number>}: The deadzone value within which the RC signal should default to 1500.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<number>}: The converted RC signal value.

\noindent Converts a value to its equivalent RC (Radio Control) signal value, accounting for an optional deadzone.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{data2blobUrl(file\_path\_in)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{file\_path\_in} \texttt{<string>}: Relative path from the application's base path to the file.
\end{itemize}
...
\vspace{5mm}
\noindent \codeBlock{\texttt{latexToHtml(latex)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{latex} \texttt{<string>}: LaTeX/TeX input string.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<string>}: HTML/Unicode string.

\noindent Converts a subset of LaTeX/TeX math syntax into HTML/Unicode.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{parseArduinoOutput(output)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\vspace{5mm}
\noindent \codeBlock{\texttt{requestSerialPort()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Returns:} \texttt{<Promise.<(Object|false)>>}: 

\noindent Prompts the browser to authorize a serial port if supported.
...
\subsection{system}
\vspace{5mm}
\noindent \code{\texttt{open\_terminals}}{\color{jsl-gray}\vspace{2mm}\hrule}\vspace{4mm}


\noindent \textbf{Type:} \texttt{<Unknown>}

\noindent Array of open terminals.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{spawnTerminal(args, onData, onExit)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{args} \texttt{<Array>}: Arguments forwarded to PTY spawn (e.g. [file, argv, options]).
  \item \texttt{onData} \texttt{<function>}: Callback invoked on terminal output (string).
  \item \texttt{onExit} \texttt{<function>}: Callback invoked when the terminal exits.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_SYSTEM\_TERMINAL>}: Terminal wrapper instance.

\noindent Spawns a new PTY-backed terminal session and registers it locally.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{offsetLatLonEastNorth(lat, lon, east, north)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\begin{itemize}
  ...
  \item \texttt{east} \texttt{<number>}: The east offset in meters.
  \item \texttt{north} \texttt{<number>}: The north offset in meters.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<number>>}: An array containing the latitude and longitude of the calculated point.

\noindent Calculates a new latitude and longitude based on east and north offsets.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{latLonAltTransform(lat, lon, alt, dx, dy, dz)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{lat} \texttt{<number>}: Latitude in degrees.
  \item \texttt{lon} \texttt{<number>}: Longitude in degrees.
  \item \texttt{alt} \texttt{<number>}: Altitude in meters.
  \item \texttt{dx} \texttt{<number>}: Local x offset in meters.
  \item \texttt{dy} \texttt{<number>}: Local y offset in meters.
  \item \texttt{dz} \texttt{<number>}: Local z offset in meters.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Object>}: Object containing the transformed latitude, longitude, and altitude.

\noindent Transforms a local offset (dx, dy, dz) relative to a specified latitude, longitude, and altitude to a new latitude, longitude, and altitude.

\vspace{5mm}
\noindent \codeBlock{\texttt{eastNorthUpTransform(position, dx, dy, dz)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{position} \texttt{<Cesium.Cartesian3>}: East, North, Up position.
  \item \texttt{dx} \texttt{<number>}: Local x offset in meters.
  \item \texttt{dy} \texttt{<number>}: Local y offset in meters.
  \item \texttt{dz} \texttt{<number>}: Local z offset in meters.
\end{itemize}
...
\noindent Transforms a local offset (dx, dy, dz) relative to a specified East, North, Up position to a new latitude, longitude, and altitude.

\vspace{5mm}
\noindent \codeBlock{\texttt{computeHeadingPitchFromTo(from\_cartesian, to\_cartesian)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{from\_cartesian} \texttt{<Cesium.Cartesian3>}: The Cartesian coordinates of the starting point.
  \item \texttt{to\_cartesian} \texttt{<Cesium.Cartesian3>}: The Cartesian coordinates of the target point.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Object>}: An object containing the calculated heading (in radians from North, positive East) and pitch (in radians from the local horizontal, positive Up).

\noindent Calculates the heading (yaw) and pitch angles from a starting Cartesian point to a target Cartesian point.The angles are calculated in the local East-North-Up (ENU) frame of the starting point.

\vspace{5mm}
\noindent \codeBlock{\texttt{mslToEllipsoidAlt(lat\_deg, lon\_deg, h\_msl\_meters)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{lat\_deg} \texttt{<number>}: Latitude(s) in degrees.
  \item \texttt{lon\_deg} \texttt{<number>}: Longitude(s) in degrees.
  \item \texttt{h\_msl\_meters} \texttt{<number>}: Altitude(s) in meters above MSL.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<number>}: Ellipsoid altitude(s) in meters.

\noindent Converts altitude from Mean Sea Level (MSL) height to Ellipsoid height using the EGM96 geoid model.The conversion can handle single values or arrays of values.

\vspace{5mm}
\noindent \codeBlock{\texttt{ellipsoidToMslAlt(lat\_deg, lon\_deg, h\_ellipsoid\_meters)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\begin{itemize}
  \item \texttt{lat\_deg} \texttt{<number>}: Latitude(s) in degrees.
  \item \texttt{lon\_deg} \texttt{<number>}: Longitude(s) in degrees.
  \item \texttt{h\_ellipsoid\_meters} \texttt{<number>}: Altitude(s) in meters above the Ellipsoid.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<number>}: MSL altitude(s) in meters.

\noindent Converts altitude from Ellipsoid height to Mean Sea Level (MSL) height using the EGM96 geoid model.The conversion can handle single values or arrays of values.

\vspace{5mm}
\noindent \codeBlock{\texttt{positionToEllipsoid(lat\_deg, lon\_deg, h\_msl\_meters)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<Cesium.Cartesian3>}: Cartesian coordinate(s) in the WGS84 system.

\noindent Converts a position (latitude, longitude, and MSL altitude) into a Cesium Cartesian3 coordinate using Ellipsoid height.The MSL altitude is first converted to Ellipsoid altitude using the EGM96 geoid model.
...
\begin{itemize}
  \item \texttt{number} \texttt{<number>}: The number to format.
  \item \texttt{digits} \texttt{<number>}: The number of significant digits to produce.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<string>}: A string containing the formatted number.

\noindent Formats a floating-point number to a fixed number of significant digits,automatically adjusting decimal places depending on the integer part length.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{isPlainObject(value)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<boolean>}: True if the value is a plain object, false otherwise.

\noindent Determines if the provided value is a plain object.

\vspace{5mm}
\noindent \codeBlock{\texttt{isTypedArray(value)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<boolean>}: True if the value is a typed array, false otherwise.

\noindent Determines if the provided value is a typed array.

\vspace{5mm}
\noindent \codeBlock{\texttt{isColumnLike(value)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<boolean>}: True if the value is an array or typed array.

\noindent Determines if the provided value is array-like for column-style input.

\vspace{5mm}
\noindent \codeBlock{\texttt{ensureUniqueNames(names, [error\_factory])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{names} \texttt{<Array.<string>>}: Name list.
  \item \texttt{error\_factory} \texttt{<function>}: Optional function that returns an Error for a duplicate name.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: True when all names are unique.

\noindent Ensures that name list contains unique values.Throws when a duplicate name is found.

\vspace{5mm}
\noindent \codeBlock{\texttt{compareMixedValues(a, b)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{a} \texttt{<*>}: First value.
  \item \texttt{b} \texttt{<*>}: Second value.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<number>}: Comparison result.

\noindent Compares mixed values for stable sorting.

\vspace{5mm}
\noindent \codeBlock{\texttt{buildSortedIndices(length, getter, [direction])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{length} \texttt{<number>}: Number of rows/items.
  \item \texttt{getter} \texttt{<function>}: Getter by index.
  \item \texttt{direction} \texttt{<string>}: Sort direction.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<number>>}: Sorted indices.

\noindent Builds stable sorted index order.

\vspace{5mm}
\noindent \codeBlock{\texttt{rangeIndices(n)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{n} \texttt{<number>}: Length.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<number>>}: Range indices.

\noindent Creates [0, ..., n - 1].

\vspace{5mm}
\noindent \codeBlock{\texttt{isMissingValue(value)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{value} \texttt{<*>}: Candidate value.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: True when value is missing.

\noindent Checks if value should be treated as missing.

\vspace{5mm}
\noindent \codeBlock{\texttt{valueTypeLabel(value)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<string>}: Type label.

\noindent Resolves type label for table-like display.

\vspace{5mm}
\noindent \codeBlock{\texttt{csvEscapeCell(value, [delimiter])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{value} \texttt{<*>}: Cell value.
  \item \texttt{delimiter} \texttt{<string>}: Delimiter.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<string>}: Escaped CSV token.

\noindent Escapes CSV cell text.

\vspace{5mm}
\noindent \codeBlock{\texttt{parseCsvLine(line, [delimiter])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{line} \texttt{<string>}: Input line.
  \item \texttt{delimiter} \texttt{<string>}: Delimiter.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<string>>}: Parsed fields.

\noindent Parses a CSV line with quoted fields support.

\vspace{5mm}
\noindent \codeBlock{\texttt{parseCsvText(text, [delimiter])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{text} \texttt{<string>}: CSV text.
  \item \texttt{delimiter} \texttt{<string>}: Delimiter.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<Array.<string>>>}: Parsed rows.

\noindent Parses CSV-like text into rows.

\vspace{5mm}
\noindent \codeBlock{\texttt{detectDelimiter(text, [fallback])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{text} \texttt{<string>}: Input text.
  \item \texttt{fallback} \texttt{<string>}: Fallback delimiter.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<string>}: Detected delimiter.

\noindent Detects CSV delimiter from the first non-empty line.

\vspace{5mm}
\noindent \codeBlock{\texttt{parseCsvScalar(text, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{text} \texttt{<string>}: Raw text.
  \item \texttt{options} \texttt{<Object>}: Parse options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<*>}: Parsed scalar value.

\noindent Converts textual CSV token into a typed scalar.

\vspace{5mm}
\noindent \codeBlock{\texttt{aggregateValues(values, method)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{values} \texttt{<Array>}: Input values.
  \item \texttt{method} \texttt{<string>}: Aggregation method.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<*>}: Aggregated result.

\noindent Aggregates values using the selected method.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{isEmptyObject(obj)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{obj} \texttt{<string>}: The object to check.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: - True if the object is empty, otherwise false.

\noindent Checks if a object is empty.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{escapeHTMLAttr(value)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{value} \texttt{<*>}: The value to escape.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<string>}: Escaped attribute-safe text.

\noindent Escapes text for use in HTML attributes.
...
\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{object} \texttt{<Object>}: The object to test for key collisions.
  \item \texttt{key} \texttt{<string>}: The proposed key name.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<string>}: A unique key string not present in the object.

\noindent Produces a unique key name inside an object. If \textasciigrave{}key\textasciigrave{} already exists,numerical suffixes are appended until uniqueness is achieved.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{bold(s)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{s} \texttt{<string>}: The string to wrap.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<string>}: The bold-formatted HTML string.

\noindent Wraps a string with an HTML <b> tag for bold formatting.

\vspace{5mm}
\noindent \codeBlock{\texttt{italic(s)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<string>}: The italic-formatted HTML string.

\noindent Wraps a string with an HTML <i> tag for italic formatting.

\vspace{5mm}
\noindent \codeBlock{\texttt{underline(s)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<string>}: The underline-formatted HTML string.

\noindent Wraps a string with an HTML <u> tag for underline formatting.

\vspace{5mm}
\noindent \codeBlock{\texttt{strike(s)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<string>}: The strikethrough HTML string.

\noindent Wraps a string with an HTML <s> tag for strikethrough formatting.

\vspace{5mm}
\noindent \codeBlock{\texttt{sub(s)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<string>}: The subscript HTML string.

\noindent Wraps a string in an HTML <sub> element (subscript).

\vspace{5mm}
\noindent \codeBlock{\texttt{sup(s)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<string>}: The superscript HTML string.

\noindent Wraps a string in an HTML <sup> element (superscript).

\vspace{5mm}
\noindent \codeBlock{\texttt{tableprint(args)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{args} \texttt{<Array>}: Table columns followed by options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Object>}: Result object with \textasciigrave{}plain\textasciigrave{} and \textasciigrave{}tex\textasciigrave{} strings.

\noindent Prints a formatted plain-text table and optionally exports a LaTeX table.Columns are Arrays/TypedArrays (all same length). Options can be passed as parameter/valuepairs or as a final options object.Options: VariableNames, RowNames, Format, Save ("no"|"plain"|"tex"), File, rlines, clines,align, float, caption, label, escapeTeX.


\subsection{table}
\vspace{5mm}
\noindent \codeBlock{\texttt{table(args)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{args} \texttt{<*>}: Columns and options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Creates a table from columns.Usage examples:table(colA, colB, \{ VariableNames: ['A', 'B'] \})table(\{ A: colA, B: colB \})table(colA, colB, 'VariableNames', ['A', 'B'])

\vspace{5mm}
\noindent \codeBlock{\texttt{timetable(row\_times, args)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{row\_times} \texttt{<Array>}: Row times.
  \item \texttt{args} \texttt{<*>}: Columns and options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TIMETABLE>}: 

\noindent Creates a timetable from row times and columns.Usage examples:timetable(times, colA, colB, \{ VariableNames: ['A', 'B'] \})timetable(times, \{ A: colA, B: colB \})

\vspace{5mm}
\noindent \codeBlock{\texttt{array2table(A, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{A} \texttt{<Array>}: 2D row-major array.
  \item \texttt{options} \texttt{<Object>}: Table options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Creates a table from a 2D array.

\vspace{5mm}
\noindent \codeBlock{\texttt{struct2table(rows, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{rows} \texttt{<Array.<Object>>}: Array of row objects.
  \item \texttt{options} \texttt{<Object>}: Table options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Creates a table from an array of objects.

\vspace{5mm}
\noindent \codeBlock{\texttt{table2array(T)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{T} \texttt{<PRDC\_JSLAB\_TABLE>}: Table-like object.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<Array>>}: 

\noindent Converts a table/timetable into a 2D array.

\vspace{5mm}
\noindent \codeBlock{\texttt{istable(value)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Checks whether value is a table.

\vspace{5mm}
\noindent \codeBlock{\texttt{istimetable(value)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Checks whether value is a timetable.

\vspace{5mm}
\noindent \codeBlock{\texttt{readtable(file\_path, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{file\_path} \texttt{<string>}: File path.
  \item \texttt{options} \texttt{<Object>}: Read options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Reads a delimited text file into a table.

\vspace{5mm}
\noindent \codeBlock{\texttt{readtimetable(file\_path, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Reads a delimited text file into a timetable.

\vspace{5mm}
\noindent \codeBlock{\texttt{table2csv(T, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{T} \texttt{<PRDC\_JSLAB\_TABLE>}: Table-like value.
  \item \texttt{options} \texttt{<Object>}: CSV options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<string>}: 

\noindent Serializes table/timetable into CSV text.

\vspace{5mm}
\noindent \codeBlock{\texttt{writetable(T, file\_path, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{T} \texttt{<PRDC\_JSLAB\_TABLE>}: Table-like value.
  \item \texttt{file\_path} \texttt{<string>}: Output file path.
  \item \texttt{options} \texttt{<Object>}: Write options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: 

\noindent Writes table/timetable to CSV/TSV file.

\vspace{5mm}
\noindent \codeBlock{\texttt{retime(TT, step, [method], [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{TT} \texttt{<PRDC\_JSLAB\_TIMETABLE>}: Input timetable.
  \item \texttt{step} \texttt{<number>}: Bucket step.
  \item \texttt{method} \texttt{<string>}: Aggregation method.
  \item \texttt{options} \texttt{<Object>}: Additional options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TIMETABLE>}: 

\noindent Retime timetable using fixed bucket step.

\vspace{5mm}
\noindent \codeBlock{\texttt{join(left, right, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{left} \texttt{<PRDC\_JSLAB\_TABLE>}: Left table.
  \item \texttt{right} \texttt{<PRDC\_JSLAB\_TABLE>}: Right table.
  \item \texttt{options} \texttt{<Object>}: Join options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Alias for innerjoin.

\vspace{5mm}
\noindent \codeBlock{\texttt{innerjoin(left, right, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Performs inner join.

\vspace{5mm}
\noindent \codeBlock{\texttt{outerjoin(left, right, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Performs outer join.

\vspace{5mm}
\noindent \codeBlock{\texttt{groupsummary(T, groupvars, [method], [datavars])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{T} \texttt{<PRDC\_JSLAB\_TABLE>}: Input table.
  \item \texttt{groupvars} \texttt{<Array>}: Grouping variables.
  \item \texttt{method} \texttt{<Array>}: Aggregation method(s).
  \item \texttt{datavars} \texttt{<Array>}: Variables to aggregate.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Groups rows and computes aggregates.

\vspace{5mm}
\noindent \codeBlock{\texttt{varfun(fun, T, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{fun} \texttt{<function>}: Function or aggregator name.
  \item \texttt{T} \texttt{<PRDC\_JSLAB\_TABLE>}: Input table.
  \item \texttt{options} \texttt{<Object>}: Options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Applies a function to selected table variables.

\vspace{5mm}
\noindent \codeBlock{\texttt{ismissing(value)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{value} \texttt{<*>}: Input value.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<*>}: 

\noindent Missing-value mask for scalar/array/table.

\vspace{5mm}
\noindent \codeBlock{\texttt{fillmissing(value, [method], [fill\_value])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{value} \texttt{<*>}: Input value.
  \item \texttt{method} \texttt{<string>}: Fill method.
  \item \texttt{fill\_value} \texttt{<*>}: Constant replacement value.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<*>}: 

\noindent Fills missing values for scalar/array/table.
...
\noindent Creates an instance of PRDC\_JSLAB\_GEOMETRY\_SPACE\_SEARCH.

\vspace{5mm}
\noindent \codeBlock{\texttt{boundaryFollow2D()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent Creates an instance of PRDC\_JSLAB\_GEOMETRY\_BOUNDARY\_FOLLOW\_2D.

\vspace{5mm}
\noindent \codeBlock{\texttt{boundaryFollow3D()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent Creates an instance of PRDC\_JSLAB\_GEOMETRY\_BOUNDARY\_FOLLOW\_3D.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{pointSegmentDistance(p, a, b)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{p} \texttt{<Object>}: Query point.
  \item \texttt{a} \texttt{<Object>}: Segment start point.
  \item \texttt{b} \texttt{<Object>}: Segment end point.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<number>}: The minimal distance from p to the segment a-b.

\noindent Computes the shortest distance from a point to a line segment in 2D.The point and segment endpoints are expected as objects with numericproperties \{x, y\}. The result is the Euclidean distance to the closestpoint on the segment.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{updatePresentation(file\_path)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Updates generated presentation internal files to the latest JSLAB runtime.
...
\vspace{5mm}
\noindent \codeBlock{\texttt{makeOnlinePresentation(file\_path)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Restores a standalone-cleaned presentation back to the normal server-backed form.
...
\subsection{Table}
\vspace{5mm}
\noindent \codeBlock{\texttt{height()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Returns:} \texttt{<number>}: 

\noindent Gets table height (number of rows).

\vspace{5mm}
\noindent \codeBlock{\texttt{width()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Returns:} \texttt{<number>}: 

\noindent Gets table width (number of variables).
...
\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{dim} \texttt{<number>}: Dimension index (0 or 1).
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Array.<number>>}: 

\noindent Gets size tuple [height, width] or one dimension.

\vspace{5mm}
\noindent \codeBlock{\texttt{hasVariable(name)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{name} \texttt{<string>}: Variable name.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: 

\noindent Checks whether variable name exists.

\vspace{5mm}
\noindent \codeBlock{\texttt{getVariable(name)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Returns:} \texttt{<Array>}: 

\noindent Gets variable column.

\vspace{5mm}
\noindent \codeBlock{\texttt{setVariable(name, values)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{name} \texttt{<string>}: Variable name.
  \item \texttt{values} \texttt{<*>}: Column values.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Sets or creates a variable column.

\vspace{5mm}
\noindent \codeBlock{\texttt{selectvars(names)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{names} \texttt{<Array>}: Variable names.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Returns selected variables as a new table.

\vspace{5mm}
\noindent \codeBlock{\texttt{removevars(names)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{names} \texttt{<Array>}: Variable names to remove.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Removes variables and returns a new table.

\vspace{5mm}
\noindent \codeBlock{\texttt{renamevars(old\_names, new\_names)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{old\_names} \texttt{<Array>}: Existing variable names.
  \item \texttt{new\_names} \texttt{<Array>}: New variable names.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Renames variables and returns a new table.

\vspace{5mm}
\noindent \codeBlock{\texttt{addvars(args)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{args} \texttt{<*>}: Variables and optional \{ NewVariableNames: [] \}.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Appends variables and returns a new table.

\vspace{5mm}
\noindent \codeBlock{\texttt{subsetRows(row\_selector)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{row\_selector} \texttt{<number>}: Row selector.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Returns a row subset as a new table.

\vspace{5mm}
\noindent \codeBlock{\texttt{rows(row\_selector)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Alias for subsetRows.

\vspace{5mm}
\noindent \codeBlock{\texttt{head([n])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{n} \texttt{<number>}: Rows count.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Returns first N rows.

\vspace{5mm}
\noindent \codeBlock{\texttt{tail([n])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Returns last N rows.

\vspace{5mm}
\noindent \codeBlock{\texttt{filter(predicate)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{predicate} \texttt{<function>}: Row predicate.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Filters rows using predicate.

\vspace{5mm}
\noindent \codeBlock{\texttt{sortrows(by, [direction])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{by} \texttt{<string>}: Variable name or column index.
  \item \texttt{direction} \texttt{<string>}: Sort direction.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Sorts rows by variable.

\vspace{5mm}
\noindent \codeBlock{\texttt{innerjoin(right, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Inner join with another table.

\vspace{5mm}
\noindent \codeBlock{\texttt{outerjoin(right, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Outer join with another table.

\vspace{5mm}
\noindent \codeBlock{\texttt{join(right, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Alias for inner join.

\vspace{5mm}
\noindent \codeBlock{\texttt{groupsummary(groupvars, [method], [datavars])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\begin{itemize}
  \item \texttt{groupvars} \texttt{<Array>}: Grouping variables.
  \item \texttt{method} \texttt{<Array>}: Aggregation method(s).
  \item \texttt{datavars} \texttt{<Array>}: Data variable names.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Group summary for this table.

\vspace{5mm}
\noindent \codeBlock{\texttt{varfun(fun, [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{fun} \texttt{<function>}: Function or aggregate name.
  \item \texttt{options} \texttt{<Object>}: varfun options.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Applies a function to table variables.

\vspace{5mm}
\noindent \codeBlock{\texttt{ismissing()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Missing-value mask table.

\vspace{5mm}
\noindent \codeBlock{\texttt{fillmissing([method], [fill\_value])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{method} \texttt{<string>}: Fill method.
  \item \texttt{fill\_value} \texttt{<*>}: Fill value.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TABLE>}: 

\noindent Filled table copy.

\vspace{5mm}
\noindent \codeBlock{\texttt{variableTypes([max\_scan\_rows])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{max\_scan\_rows} \texttt{<number>}: Max rows to inspect per variable.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Object.<string, string>>}: 

\noindent Returns inferred variable types.

\vspace{5mm}
\noindent \codeBlock{\texttt{toObjectRows()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Returns:} \texttt{<Array.<Object>>}: 

\noindent Converts table to row objects.
...
\noindent Converts table to 2D array.

\vspace{5mm}
\noindent \codeBlock{\texttt{toColumns()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Returns:} \texttt{<Object.<string, Array>>}: 

\noindent Returns plain object with cloned columns.

\vspace{5mm}
\noindent \codeBlock{\texttt{summary()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Returns:} \texttt{<Object>}: 

\noindent Returns summary object.

\vspace{5mm}
\noindent \codeBlock{\texttt{getInspectorColumns()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Returns:} \texttt{<Array.<Object>>}: 

\noindent Returns inspector column definitions.

\vspace{5mm}
\noindent \codeBlock{\texttt{getInspectorRows()}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Returns:} \texttt{<Array.<Object>>}: 

\noindent Returns inspector row payload.

\vspace{5mm}
\noindent \codeBlock{\texttt{setCell(row\_index, column\_name, value)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{row\_index} \texttt{<number>}: Row index.
  \item \texttt{column\_name} \texttt{<string>}: Column name or index.
  \item \texttt{value} \texttt{<*>}: New value.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: 

\noindent Sets cell value.

\vspace{5mm}
\noindent \codeBlock{\texttt{getCell(row\_index, column\_name)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Safe JSON representation.
...
\noindent Pretty string representation.
...
\noindent Gets timetable height.

\vspace{5mm}
\noindent \codeBlock{\texttt{setRowTimes(row\_times)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{row\_times} \texttt{<*>}: Row times column.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TIMETABLE>}: 

\noindent Sets row times.
...
\noindent Returns row subset as new timetable.
...
\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{by} \texttt{<string>}: Sort key.
  \item \texttt{direction} \texttt{<string>}: Sort direction.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TIMETABLE>}: 

\noindent Sorts rows by row times or variable.

\vspace{5mm}
\noindent \codeBlock{\texttt{retime(step, [method], [options])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent Retimes timetable with fixed bucket size.

\vspace{5mm}
\noindent \codeBlock{\texttt{timerange(start\_time, end\_time)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{start\_time} \texttt{<*>}: Inclusive lower bound.
  \item \texttt{end\_time} \texttt{<*>}: Inclusive upper bound.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<PRDC\_JSLAB\_TIMETABLE>}: 

\noindent Selects rows within [start\_time, end\_time].
...
\noindent Converts timetable to row objects.
...
\begin{itemize}
  \item \texttt{row\_index} \texttt{<number>}: Row index.
  \item \texttt{column\_name} \texttt{<string>}: Column name.
  \item \texttt{value} \texttt{<*>}: New value.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<boolean>}: 

\noindent Sets cell value (supports row times through "\_\_rowtime\_\_").
...
\vspace{5mm}
\noindent \codeBlock{\texttt{inputParser(message)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\subsection{boundary\_follow\_2d}
\vspace{5mm}
\noindent \codeBlock{\texttt{resetLogs([keepCache])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{keepCache} \texttt{<boolean>}: 
\end{itemize}

\noindent Resets logging and optionally clears the feasibility cache.

\vspace{5mm}
\noindent \codeBlock{\texttt{trace(dx, dy, [ambiguous])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{dx} \texttt{<number>}: 
  \item \texttt{dy} \texttt{<number>}: 
  \item \texttt{ambiguous} \texttt{<string>}: 
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Object>}: - Result object (diagnostics + closed flag).

\noindent Main entry (2D).


\subsection{boundary\_follow\_3d}
\vspace{5mm}
\noindent \codeBlock{\texttt{resetLogs([keepCache])}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}
...
\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{keepCache} \texttt{<boolean>}: If true, keeps the feasibility cache; otherwise cache is cleared.
\end{itemize}

\noindent \textbf{Returns:} \texttt{<void>}: No return value.

\noindent Resets logging and optionally clears the feasibility cache.

\vspace{5mm}
\noindent \codeBlock{\texttt{trace(dx, dy, dz)}}{\color{jsl-gray}\vspace{2mm}\hrule\vspace{4mm}}


\noindent \textbf{Parameters:}
\begin{itemize}
  \item \texttt{dx} \texttt{<number>}: Fine grid spacing in X (must be >0).
  \item \texttt{dy} \texttt{<number>}: Fine grid spacing in Y (must be >0).
  \item \texttt{dz} \texttt{<number>}: Fine grid spacing in Z (must be >0).
\end{itemize}

\noindent \textbf{Returns:} \texttt{<Object>}: Result object:  - dim: 3  - closed: true if the mixed-voxel component does not touch bbox boundary; false otherwise  - touchesBoundary: true if flood-fill hit voxel-grid boundary; false otherwise  - surfaceCells: number of mixed voxels visited (surface voxel count)  - evalCount: total feasibility evaluations performed  - N: [feasible\_points,infeasible\_points], each is an array of [x,y,z]  - grid: \{dx,dy,dz,nx,ny,nz\} fine grid diagnostics  - seed: coarse seed edge diagnostics (used steps + endpoints + orientation)  - fineBracket: refined fine flip bracket used to start flood-fill  - startVoxel: voxel indices used as flood-fill start

\noindent Main entry (3D).
